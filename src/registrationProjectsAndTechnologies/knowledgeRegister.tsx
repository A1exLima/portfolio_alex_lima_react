...
export const knowledgeRegisterText: { [key: string]: string } = {
  ...
  axios:
    'Axios é uma biblioteca JavaScript para requisições HTTP, facilitando a comunicação entre frontend e backend com uma interface baseada em Promises. Suporta navegadores e Node.js, permitindo métodos como GET, POST, PUT, DELETE. Oferece funcionalidades avançadas como cancelamento de requisições e interceptores para transformação de dados. É popular devido à sua simplicidade, eficiência e robustez em aplicações modernas.',
  styledComponents:
  ...
  express:
    'Express é um framework minimalista para Node.js, facilitando a criação de servidores robustos para aplicações web e APIs. Ele oferece funcionalidades essenciais como roteamento, middleware e tratamento de solicitações HTTP, permitindo desenvolvimento rápido e eficiente. Sua flexibilidade e popularidade o tornam ideal para projetos pequenos e grandes, frequentemente integrado com tecnologias como MongoDB e Angular no MEAN stack.',
}
